...
import softwareSales from '../assets/png/softwareSales.png'
import businessDevelopment from '../assets/png/businessDevelopment.png'
import analyticsAndSaas from '../assets/png/saas.png'
import salesMethod from '../assets/png/salesMetho.png'

export const skillsImage = (skill) => {
    const skillID = skill.toLowerCase();
    switch (skillID) {
        case 'Analytics & SAAS Solutions':
            return analyticsAndSaas;
        case 'business development':
            return businessDevelopment;
        case 'sales methodologies':
            return salesMethod;
        case 'gcp':
            return gcp;
        case 'software sales':
            return softwareSales;
        case 'html':
            return html;
        case 'photoshop':
            return photoshop;
